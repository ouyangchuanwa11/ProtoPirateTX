...
void scene_receive_alloc(ProtoPirateApp* app) {
    ...
    widget_add_string_element(app->widget, 64, 25, AlignCenter, AlignTop, FontSecondary,
                              "Press car key fob button");
    widget_add_string_element(app->widget, 64, 45, AlignCenter, AlignTop, FontSecondary,
                              "near the Flipper Zero");
    widget_add_string_element(app->widget, 64, 65, AlignCenter, AlignTop, FontKeyboard,
...
void scene_receive_enter(ProtoPirateApp* app) {
    ...
    // ????: 10???
    uint32_t timeout = furi_get_tick() + 10000;
